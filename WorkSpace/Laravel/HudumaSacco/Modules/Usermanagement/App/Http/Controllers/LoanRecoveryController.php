...
class LoanRecoveryController extends Controller
{
    ...
    {
        $data['page_title']="Loan Re-covery/Re-Payment";
        return view('usermanagement::Adminportal.LoanRecovery.index',$data);
    }

    public function fetchList()
    {
         $models=DB::select("select id,Paydate,SiteId,PayrollNum,IdNumber,AgentType,RegNum,AgentCode,BranchCode,AccountNum,EDCode,EdName,format(Amount,2)Amount ,format(Balance,2) Balance,Name,Status  from  member_transactions where edcode=? ",[938]);
