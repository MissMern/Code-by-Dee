...
<a href="<?=url('/AdminModule/ApproverUser/Create');?>" title="Add New Approver" class="btn btn-sm btn-success"><span class="fa fa-plus">Create New Approver </span></a>
...
@push('scripts')
     <script>
        ...
        "order": [[ 3, "desc" ]],
         ajax: {
            url: '<?=url("AdminModule/Approvers/fetchList")?>',
             'type': 'POST',
              headers: {
