...
class EdCodesController extends Controller
{
    ...
    {
        $data['page_title']="EDCodes";
        return view('usermanagement::Adminportal.EDCodes.index',$data);
    }

    public function fetchList()
    {
         $models=DB::select("select id,created_at,EDCode,EdName from edcodes ");
