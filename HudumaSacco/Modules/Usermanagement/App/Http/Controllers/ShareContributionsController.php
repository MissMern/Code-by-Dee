...
class ShareContributionsController extends Controller
{
     protected $branchId;
    protected $orgId;
    ...
    {
        $data['page_title']="Share Contributions";
        return view('usermanagement::Adminportal.ShareContributions.index',$data);
    }

    public function fetchList()
    {
         $models=DB::select("select id,Paydate,SiteId,PayrollNum,IdNumber,AgentType,RegNum,AgentCode,BranchCode,AccountNum,EDCode,EdName,format(Amount,2)Amount ,format(Balance,2) Balance,Name,Status  from  member_transactions where edcode=? ",[939]);
...
';
    ...
    {
         $model=MemberTransaction::find($id);
          $data['model']=$model;

         return view('usermanagement::Adminportal.ShareContributions._views',$data);
